    ...
    <div className="min-h-screen w-full bg-background-primary flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex justify-center items-center p-0 overflow-auto relative z-10">
        <div className="w-full max-w-7xl mx-auto px-4 flex flex-col h-full justify-center">
          ...
          >
            {/* Enhanced featured badge - hide on mobile to save space */}
            {!isMobile && (
              <motion.div 
            ...
            {/* Enhanced main headline - smaller on mobile */}
            <motion.h1 
            ...
            {/* Enhanced subtitle - shorter on mobile */}
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {isMobile 
                ? 'The most advanced AI platform for next-generation creators.'
                : 'Experience the future of AI-powered creativity. The most advanced platform designed for next-generation creators who demand excellence.'
              }
            </motion.p>
            
            {/* Enhanced feature highlights - condensed on mobile */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              className={`flex justify-center text-sm ${
                isMobile 
                  ? 'flex-col gap-2 mb-6' 
                  : 'flex-wrap gap-8 mb-12'
              }`}
            >
              {isMobile ? (
                // Show only 2 key features on mobile
                <>
                  <div className="flex items-center justify-center gap-3 badge-primary">
            ...
            {/* Enhanced CTA buttons - simplified on mobile */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          {/* Enhanced chat interface - smaller on mobile */}
          <motion.div
          ...
          {/* Enhanced bottom features - hide on mobile */}
          {!isMobile && (
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
